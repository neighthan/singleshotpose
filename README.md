...
```
python valid_multi.py --modelcfg cfgfile --initweightfile weightfile
```
e.g.
```
python valid_multi.py --modelcfg cfg/yolo-pose-multi.cfg --initweightfile backup_multi/model_backup.weights
```
