...
if __name__ == "__main__":
    proj_root = Path(__file__).parent / "../singleshotpose"
    multi_root = proj_root / "multi_obj_pose_estimation"
    cfg_dir = (multi_root / "cfg").resolve()

    parser = ArgumentParser(description="SingleShotPose")
    parser.add_argument("--modelcfg", default=str(cfg_dir / "yolo-pose-multi.cfg"))
    parser.add_argument("--initweightfile", default=str(multi_root / "backup_multi/model_backup.weights"))
